...
import { FiUser, FiLock, FiMail, FiAlertCircle, FiUserCheck } from 'react-icons/fi';
    ...
    <div className="flex min-h-screen bg-gradient-to-br from-blue-100 via-white to-indigo-100">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-indigo-600 flex-col justify-center items-center text-white p-12">
        <div className="max-w-md">
          ...
          <p className="text-xl mb-6">Join our platform to transform urban infrastructure management.</p>
        ...
        <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-xl shadow-lg">
          <div>
            ...
            <p className="mt-2 text-center text-sm text-gray-600">
              Join us to start monitoring your city infrastructure
            </p>
          </div>
